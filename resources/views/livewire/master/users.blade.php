                                ...
                                <div x-cloak x-show="modelOpen"
                                    ...
                                    <form class="mt-5" wire:submit.prevent="save">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <input wire:model="no_hp" placeholder="Masukan Handphone" type="number"
                                                class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                                            @error('no_hp')
                                                <span class="text-red-300">{{ $message }}</span>
                                            @enderror
                        ...
                        <div x-cloak x-show="showModal"
                            ...
                            <form class="mt-5" wire:submit.prevent="update">
                                ...
                                <div class="mt-4">
                                    ...
                                    <input wire:model="no_hp" placeholder="Masukan Kode Unit" type="number"
                                        class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                                    @error('no_hp')
                                        <span class="text-red-300">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="mt-4">
                                    <label for=""
                                        class="block text-sm text-gray-700 capitalize dark:text-gray-200">Upline <span class="text-red-500">*</span></label>
                                   <input wire:model="referal" placeholder="Masukan Kode Unit" type="text"
                                        class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                                    @error('referal')
                                        <span class="text-red-300">{{ $message }}</span>
                                    @enderror
